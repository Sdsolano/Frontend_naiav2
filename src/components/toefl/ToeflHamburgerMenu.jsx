...
import { X, Home, MessageSquare, Info, ExternalLink, Sparkles, BookOpen } from 'lucide-react';

const ToeflHamburgerMenu = ({ isOpen, onClose }) => {
  // Cerrar con Escape y prevenir scroll del body
  useEffect(() => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      description: 'Sitio web oficial TOEFL',
      external: true,
  ...
  return (
    <>
      ...
      {/* Menu Panel FLOTANTE con glassmorphism */}
      <div
      ...
      >
        ...
        <div className="absolute inset-0 overflow-hidden rounded-3xl">
          <div className="absolute top-0 right-0 w-40 h-40 bg-gradient-to-bl from-blue-400 to-indigo-400 opacity-20 rounded-full blur-3xl animate-pulse"></div>
          <div className="absolute bottom-0 left-0 w-32 h-32 bg-gradient-to-tr from-indigo-400 to-blue-400 opacity-20 rounded-full blur-2xl animate-pulse delay-1000"></div>
        </div>

        {/* Header flotante */}
        <div className="relative bg-gradient-to-r from-blue-600 via-blue-600 to-indigo-500 text-white p-6 rounded-t-3xl overflow-hidden">
          ...
          <div className="relative z-10">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h2 className="text-xl font-bold">NAIA TOEFL</h2>
                  <p className="text-blue-100 text-sm opacity-90">Preparación TOEFL</p>
                </div>
              </div>
        ...
        {/* Menu Items con efectos hover impresionantes */}
...
export default ToeflHamburgerMenu;