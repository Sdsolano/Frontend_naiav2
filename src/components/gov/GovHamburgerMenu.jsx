...
import { X, Home, MessageSquare, Info, ExternalLink, Sparkles } from 'lucide-react';

const GovHamburgerMenu = ({ isOpen, onClose }) => {
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-red-100 text-sm opacity-90">Gobernación del Atlántico</p>
                </div>
              </div>
        ...
        <div className="relative border-t border-white border-opacity-30 p-6 rounded-b-3xl bg-white bg-opacity-30 backdrop-blur-sm">
          <div className="text-center">
            <p className="text-sm text-gray-700 font-medium">
              © 2025 Gobernación del Atlántico
            </p>
...
export default GovHamburgerMenu;