...
import GovHamburgerMenu from './GovHamburgerMenu';

const HeroCarousel = () => {
  const [currentIndex, setCurrentIndex] = useState(0);
  
  const images = [
    { src: Ciudadano_AF, alt: "Asistente de Atención al Ciudadano", role: "Asistente Ciudadano" }
  ];
                ...
                <div className="space-y-4">
                 ...
                 <h1 className="text-4xl md:text-5xl font-bold leading-tight">
                  ...
                  <p className="text-lg sm:text-xl text-red-100 leading-relaxed max-w-2xl">
                    Tu asistente inteligente especializado en servicios gubernamentales del Atlántico. 
